                    ...
                    <div class="box-shadow mt-4">
                        <div class="wrapper-information">
                            ...
                            <div class="right-info">
                                ...
                                <div class="recipe-time-posted"><span class="clock-icon"><i class="far fa-clock"></i></span>Posted: <?=$posts[$i]->recipe_post_date?> | <?=$posts[$i]->recipe_post_time?> |<a href="<?=base_url()?>home/viewDetailsPostIndexView/<?=$posts[$i]->recipe_post_id?>" target="_blank"><i class="fas fa-info-circle"></i> View Details</a> |</div>
